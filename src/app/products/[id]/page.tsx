...
export default function ProductDetail({ params }: { params: { id: string } }) {
  const product = {
    ...
    category: "men",
    image: "👟",
    description: "These classic white sneakers are perfect for everyday wear. Made with premium materials and designed for comfort, they're the ideal choice for both casual outings and light activities.",
    features: [
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-6 gap-2">
                  {product.sizes.map((size) => (
                    <button
                      key={size}
                      className="border border-gray-300 py-2 px-3 rounded-lg hover:border-gray-900 hover:bg-gray-50 transition-colors"
                    >
                      {size}
                    </button>
                  ))}
              ...
              <div>
                ...
                <div className="flex gap-3">
                  {product.colors.map((color) => (
                    <button
                      key={color}
                      className="border border-gray-300 py-2 px-4 rounded-lg hover:border-gray-900 hover:bg-gray-50 transition-colors"
                    >
                      {color}
                    </button>
                  ))}
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <button className="flex-1 bg-gray-900 text-white py-3 rounded-lg hover:bg-gray-800 transition-colors font-semibold">
                    Add to Cart
                  </button>
                </div>
